...
--- Ported from openai/gpt54Prompt.tsx (formerly hiddenModelJPrompt.tsx).
--- Note: experimental concise/large variants (Gpt54Concise/Gpt54Large) are not ported
--- since they are gated by VS Code experimental flags not available in Neovim.
...
--- Gpt54Prompt — for gpt-5.4* family models.
    ...
    table.insert(
        ...
        tag(
            ...
            table.concat({
                ...
                '- File References: see fileLinkification section below for path/line formatting rules.',
